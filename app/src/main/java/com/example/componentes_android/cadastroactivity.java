...
public class cadastroactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadastroactivity);
        setTitle("Exemplo Cadastro");
        btnEnviar =(Button)findViewById(R.id.cmdEnviar);
        rdGrupoSexo=(RadioGroup)findViewById(R.id.rdgSexo);
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(rdGrupoSexo.getCheckedRadioButtonId()==R.id.rdFeminino) {
                ...
                //gravar o que foi selecionado com o checkbox
